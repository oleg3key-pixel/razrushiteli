...
$top_block_us.= '<font color=green><span class="login">Игрок <a class="tdn lwhite" href=/user/'.$users['id'].'>'.$users['login'].'</a> был заблокирован<br>Причина: <font color=red>'.$text.'</font></font>'; 
...
<form action="/ban2/'.$id.'" method="post">
Причина<br/>
...
<div class="block_link"><a class=mbtn mb2 href="/ban2/list/"><img src="/images/ico/png/black.png" alt="*"/> Все заблокированные ('.mysql_result(mysql_query('SELECT COUNT(*) FROM `block` WHERE `time` > "'.time().'"'),0).') </a></div>
<div class="line"></div>';
break;
...
echo '<div class="ribbon mb2">
   <div class="rl">
    <div class="rr">Список заблокированных</div></div></div>';
...
header('location: /ban2/list/?page='.$page);
exit;}
       ...
       <div class="wr5">
        <div class="wr6">
         <div class="wr7">
          <div class="wr8"> 
           <div class="ml10 mt5 mb5 mr10 sh cntr">
<span style="float: right;"></span>  <a href="/ban/list/?id='.$row['id'].'&delete=true&page='.$page.'"> снять</a></span>
